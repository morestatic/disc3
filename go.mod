module deepsolutionsvn.com/disc
...
require (
	...
	github.com/dislabsvn/sqlite v0.3.3-0.20220211091445-7762237de4ec
...
// replace crawshaw.io/sqlite => github.com/dislabsvn/sqlite@add-skip-tx-flag-for-open-init
