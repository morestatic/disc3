...
func (opts *DiscogsPutMastersJsonOptions) Execute(args []string) error {
	...
	err = commands.SaveDiscogsMastersJson(ctx, opts.LibStagingPath, stageCtx.i, stageCtx.f, stageCtx.m, done)
	return err
}
