...
func (opts *PutArtistsReleasesJsonOptions) Execute(args []string) error {
	...
	err = commands.SaveArtistsReleasesJson(ctx, opts.LibStagingPath, stageCtx.i, stageCtx.f, stageCtx.m, done)
	return err
