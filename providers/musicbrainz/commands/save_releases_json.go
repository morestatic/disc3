...
func SaveMusicBrainzReleasesJson(ctx context.Context, archivePath string, stagingBasePath string, dropVersion string, es *scanner.JSONEntityStream, m progress.Meter, done chan struct{}) error {
