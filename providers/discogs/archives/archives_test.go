...
func TestShouldMakeReleasesArchiveName(t *testing.T) {
	result := archives.MakeDefaultDiscogsArchiveName(archives.Releases, "20211001", ".")
...
func TestShouldMakeArtistsArchiveName(t *testing.T) {
	result := archives.MakeDefaultDiscogsArchiveName(archives.Artists, "20211001", ".")
...
func TestShouldMakeLabelsArchiveName(t *testing.T) {
	result := archives.MakeDefaultDiscogsArchiveName(archives.Labels, "20211001", "./discogs1")
...
func TestShouldMakeMastersArchiveName(t *testing.T) {
	result := archives.MakeDefaultDiscogsArchiveName(archives.Masters, "20211001", ".")
